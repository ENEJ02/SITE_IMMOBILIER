...
$pdo = connexionBdd();
$requete = $pdo->query("SELECT * FROM advert ORDER BY id_advert DESC LIMIT 0,15");
...
<main class="container">
    <header class="p-5 mb-4 rounded-bottom">
        <section class="container-fluid py-5">
            <h1 class="display-5 fw-bold">WELCOME CHEZ "BON APPART"</h1>
            <h2 class="col-md-8 fs-4">Affichage des 15 annonces les plus récentes</h2>
        </section>
    </header>
    <a href="<?= RACINE_SITE ?>annonces.php" class="btn btn-danger">CLIQUEZ ICI POUR VOIR TOUTES LES ANNONCES</a>
